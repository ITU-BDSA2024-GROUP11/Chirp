...
public class ExampleTest : PageTest
{
    ...
    public async Task End2endtest()
    {
        ...
        await Page.Locator("li").Filter(new() { HasText = "Jacqualine Gilcoine Follow Save delete Starbuck now is what we hear the worst" }).GetByRole(AriaRole.Link).ClickAsync();
