...
public class ExampleTest : PageTest
{
    ...
    public async Task End2endtest()
    {
        ...
        await Page.Locator("li").Filter(new() { HasText = "Jacqualine Gilcoine Follow Save Starbuck now is what we hear the worst. — 2023-" }).GetByRole(AriaRole.Link).ClickAsync();
